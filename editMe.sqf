...
LOOT_BLACKLIST = [
    ...
    "O_UAV_06_backpack_F",
    "B_UAV_06_backpack_F",
    "I_UAV_06_medial_backpack_F",
    "O_UAV_06_medial_backpack_F",
    "C_IDAP_UAV_06_medical_backpack_F",
    "B_UAV_06_medial_backpack_F",
    "C_UAV_06_backpack_F",
    "C_IDAP_UAV_06_backpack_F",
    "C_UAV_06_medical_backpack_F",
    "C_UAV_06_antimine_backpack_F",
    "C_UAV_01_backpack_F",
...
BULWARK_BUILDITEMS = [
	...
	// [510,   "Caja explosivos",      "Box_NATO_AmmoOrd_F",                0,   1, false],
	...
	// [1050,  "Caja ACE",             "ACE_Box_Misc",                      0,   1, false],
